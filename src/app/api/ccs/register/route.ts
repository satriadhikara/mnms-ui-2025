...
export async function POST(request: NextRequest) {
    try {
        ...
        if (!teamName || !teamLeaderName || !teamMember1Name || !teamMember2Name || !teamMember3Name || !university || !major || !email || !phoneNumber || !teamPersonalDataFile || !scannedProofOfPayment) {
