...
const IICFormPage = () => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (response.ok) {
                setSubmitMessage("Registration submitted successfully! Thank you for registering for MnMs' Innovative Infographic Competition.")
                setIsError(false)
                form.reset()
            } else {
    ...
    return (<>
        <div className="min-h-screen absolute top-0 left-0 w-full">
            ...
            <Image src="/images/ccs/glass-top.png" alt="CCS Glass Top Banner" width={1920} height={1080} className="absolute top-0 left-0 w-full -z-10" />
                ...
                <div className="flex justify-center">
                    <div className="max-w-4xl w-full">
                        <h1 className="text-[#F9F9F9] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-center sm:text-left">
                            ...
                            <span className="text-[#F9F9F9] text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-5xl font-extrabold underline">Innovative Infographic Competition</span>
                        </h1>
